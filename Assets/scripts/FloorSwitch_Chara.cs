public class FloorSwitch_Chara : Switch_Chara
{
...
//	public override void self_toggled_by(ObjectAnchor trigger_obj_anchor)
//	{

//		// Inherit the parent behavior
//		base.self_toggled_by(trigger_obj_anchor);
